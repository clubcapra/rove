...
def generate_launch_description():
    ...
    icp_odometry_node = Node(
        ...
        remappings=[("scan_cloud", "/velodyne_points"), ("odom", "/icp_odom")],
    )
    ...
    point_cloud_assembler_node = Node(
        ...
        remappings=[("cloud", "/velodyne_points"), ("odom", "/odometry/local")],
    )
    ...
    rtabmap_node = Node(
        ...
        remappings=[("scan_cloud", "/assembled_cloud"), ("odom", "/odometry/local")],
        arguments=[
