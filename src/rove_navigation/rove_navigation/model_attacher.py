...
class ModelAttacherNode(Node):
    def __init__(self):
        ...
        self.parent_model = (
            self.get_parameter("parent_model").get_parameter_value().string_value
        )
        self.child_model = (
            self.get_parameter("child_model").get_parameter_value().string_value
        )
        self.parent_link = (
            self.get_parameter("parent_link").get_parameter_value().string_value
        )
        self.child_link = (
            self.get_parameter("child_link").get_parameter_value().string_value
        )
