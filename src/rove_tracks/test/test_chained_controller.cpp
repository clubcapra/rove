...
#include "test_chained_controller.hpp"
...
TEST_F(ChainedControllerTest, all_parameters_set_configure_success)
{
  SetUpController();
...
TEST_F(ChainedControllerTest, check_exported_intefaces)
{
  SetUpController();
...
TEST_F(ChainedControllerTest, activate_success)
{
  SetUpController();
...
TEST_F(ChainedControllerTest, update_success)
{
  SetUpController();
...
TEST_F(ChainedControllerTest, deactivate_success)
{
  SetUpController();
...
TEST_F(ChainedControllerTest, reactivate_success)
{
  SetUpController();
...
TEST_F(ChainedControllerTest, test_setting_slow_mode_service)
{
  SetUpController();
...
TEST_F(ChainedControllerTest, test_update_logic_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(ChainedControllerTest, test_update_logic_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(ChainedControllerTest, test_update_logic_chainable_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(ChainedControllerTest, test_update_logic_chainable_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(ChainedControllerTest, publish_status_success)
{
  SetUpController();
...
TEST_F(ChainedControllerTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
